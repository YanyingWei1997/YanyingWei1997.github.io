...
<div class="highlight-blocks">
  <div class="highlight-block floating-card">
    <h3><i class="fas fa-laptop-code"></i> Computational Social Science</h3>
    <ul>
      <li><span class="accent-text">Policy simulation</span> and agent-based modeling</li>
      <li>Machine learning for socioeconomic analysis</li>
      <li>Causal inference and staggered DID</li>
    </ul>
  </div>
...
<div class="highlight-block floating-card">
  ...
  <div class="highlight-block floating-card">
    <h3><i class="fas fa-chart-line"></i> Industrial & Regional Economics</h3>
    <ul>
      <li><span class="accent-text">Corridor economy</span> and regional development</li>
      <li>Fiscal decentralization and institutional reform</li>
      <li>Technology finance efficiency</li>
    </ul>
  </div>
</div>
...
<div class="publication-filter" role="group" aria-label="Filter publications by year">
  <button type="button" class="publication-filter-btn is-active" data-publication-filter="all">All</button>
...
<article class="publication-entry" data-year="2025">
  ...
  <div class="publication-body">
    ...
    <div class="publication-footer">
      <div class="publication-tags">
        <span class="publication-tag">Conference</span>
      </div>
      <div class="publication-links">
...
<article class="publication-entry" data-year="2022">
  ...
  <div class="publication-body">
    ...
    <div class="publication-footer">
      <div class="publication-tags">
        <span class="publication-tag">Chinese Journal</span>
      </div>
      <div class="publication-links">
...
- Python Web Scraping & Data Collection Lab
- Financial Big Data Technologies & Applications
    ...
    <div class="achievement-list">
      <article class="achievement-entry" data-level="provincial-ministerial">
        <div class="achievement-body">
          ...
          <div class="achievement-meta">PI | Guangxi Department of Education, Grant No. GXGZJG2026B264</div>
      ...
      <article class="achievement-entry" data-level="provincial-ministerial">
        <div class="achievement-body">
          ...
          <div class="achievement-meta">PI | Guangxi Zhuang Autonomous Region Philosophy and Social Sciences Office, Grant No. 25JYF186</div>
          <div class="achievement-tags"><span class="achievement-tag">Project</span><span class="achievement-tag accent">Provincial / Ministerial</span></div>
        </div>
      </article>
      <article class="achievement-entry" data-level="provincial-ministerial">
        <div class="achievement-body">
          ...
          <div class="achievement-meta">PI | Guangxi Department of Education, Grant No. 2024-KY-1871</div>
          <div class="achievement-tags"><span class="achievement-tag">Project</span><span class="achievement-tag accent">Provincial / Ministerial</span></div>
        </div>
      </article>
    ...
    <div class="achievement-list">
      <article class="achievement-entry" data-level="national">
        <div class="achievement-body">
          ...
          <div class="achievement-meta">Institute of Scientific and Technical Information of China</div>
      ...
      <article class="achievement-entry" data-level="municipal-departmental">
        <div class="achievement-body">
          ...
          <div class="achievement-meta">Industrial and Commercial Bank of China Guangxi Branch</div>
      ...
      <article class="achievement-entry" data-level="university">
        <div class="achievement-body">
          ...
          <time class="achievement-period">2024, 2025</time>
          <div class="achievement-meta">Nanning University</div>
...
<div class="local-blogs-section">
  <div class="local-blogs-header">
    <h3><i class="fas fa-pen-nib"></i> Latest Notes</h3>
